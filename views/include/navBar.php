        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="allUser.php">Mes Client</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="emcaissement.php">Encaissement</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="nav-link" href="#" data-toggle="modal" data-target="#myModal" id="creationCompt" >Nouveaux un client</a>
                </div>
              </li>
              <li class="nav-item">
                <a
